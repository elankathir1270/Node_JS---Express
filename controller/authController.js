...
const createSendResponse = (user, statusCode, res) => {
  ...
  const options = {
    ...
    //secure: true, //only for https requests
    httpOnly: true, //this is responsible for cookie, cannot be accessed by the browser and cross side scripting attack.
  };
  ...
  //Just to avoid password property only to response
